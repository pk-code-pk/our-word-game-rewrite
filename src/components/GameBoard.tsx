        ...
        {isWaitingForOpponent && (
          <div className="rounded-lg border border-zinc-200 bg-white p-5 text-center shadow-sm">
            ...
            <button
              ...
              className="mt-4 inline-flex items-center justify-center gap-2 rounded-lg bg-blue-600 px-5 py-2.5 font-semibold text-white shadow-sm transition hover:bg-blue-700"
            >
            ...
            <p className="mt-2 text-xs text-zinc-400">Sends a join link to your messaging app</p>
          </div>
        )}
